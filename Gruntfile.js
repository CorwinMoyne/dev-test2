// Generated on 2016-03-09 using generator-angular-php 0.6.3
'use strict';
        ...
        usemin: {
            ...
            options: {
                ...
                patterns: {
                    ...
                    css: [
                        [/(images\/.*?\.(?:gif|jpeg|jpg|png|webp|svg))/gm, 'Replacing references to images']
                    ],
                    js: [
        ...
        shell: {
            ...
            deploy: {
                command: [
                    ...
                    'git add .',
                    'git commit -m"deploy"',
                    'heroku git:remote -a autobay',
                    'heroku repo:reset -a autobay',
